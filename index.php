...
<html>
    <head>
        ...
        <script src="js/plotter.js" type="text/javascript"></script>
    </head>    
    <body  onload="start()"> 
        <header>
        ...
        <main>
            ...
            <div id="dvContainer">
                ...
                <div id="dvChat">                                       
                    <input type="text" id="txtChatName" placeholder="Enter your name"/>                    
                    <br />
                    
                    <textarea id="txtaChatWindow" style="height: 24em; width: 36em;"></textarea>
                    <br />
                    
                    <input type="text" id="txtChatMessage" placeholder="Enter message..."/>  
                    <label for="chkAutoScroll" style="padding-left: 1em;">Autoscroll: </label>
                    <input type="checkbox" id="chkAutoScroll" checked/>
                    <br />
                    
                    <input type="button" id="btnSendMessage" value="Send"/>
                    <p id="pChatError" style="color: red;"></p>
                </div>
                <div id="dvPlotter">
                    <form id="frmPlotter">
                        <label for="txtPlotterInput">f(x)=</label>
                        <input type="text" placeholder="Enter function" id="txtPlotterInput"/>
                        <input type="number" placeholder="Zoom" id="numPlotterZoom" value="10"/>                                                
                        <br />   
                        
                        <input type="button" value="Plot" id="btnPlot"/>             
                        <p id="pPlotterError" style="color: red;"></p>
                    </form>
                    <div id="dvPlotterOutput"></div>
                </div>
            </div>            
        </main>
    </body>
